...
class Partido(Base):
    ...
    enlace_fotmob = Column(String(250), nullable=True)
    ...
    equipo_local = relationship(
        "Equipo", foreign_keys=[id_equipo_local], back_populates="partidos_local", lazy="noload"
    )
    equipo_visita = relationship(
        "Equipo", foreign_keys=[id_equipo_visita], back_populates="partidos_visita", lazy="noload"
    )
