...
async def read_seasons(skip: int = 0, limit: int = 100, db: AsyncSession = Depends(get_db)):
    """
...
async def read_seasons_by_id(temporada_id: int, db: AsyncSession = Depends(get_db)):
    """
